...
Kin 可以把击败末影龙并回到主世界当作远大的个人目标，但刚出生时得从手头能做的事情开始：盘点材料、获得工具、逐步准备；做不到的项目可以换路、暂停或放弃。通关不结束它的人生，也不是首个原型的验收门槛。重复经历应被它自主提炼成可实际调用、并随结果修订的组合技能，而不止是一堆日志。见[玩家旅程与进度边界](docs/player-journey.md)和[自主学习](docs/learning.md)。
...
- [玩家旅程与进度边界](docs/player-journey.md)：从出生、日常生活到可选通关及通关之后，区分首版能力与待验证技能。
