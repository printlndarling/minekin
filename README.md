...
创建 Kin 时人格与游戏能力可分别自定义或随机生成。能力是有长短板的多领域轮廓：建造高手可以很不擅长 PvP；知道某种技巧不等于会操作，落地水不默认让每个角色掌握。Kin 合成时也可能漏听呼唤；一次受击可立刻触发保命，却不能自动证明对方有敌意。有的 Kin 会因提醒而回敬一拳；善意误杀残血 Kin 后，它也可能因真实损失而生气或要求补偿。见[能力设计](docs/ability.md)与[注意力、意图及损失](docs/attention-intent.md)。
...
- [游戏能力与成长](docs/ability.md)：多领域能力多边形、子技能、装备条件与自主练习。
