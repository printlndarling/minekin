...
创建 Kin 时人格与游戏能力可分别自定义或随机生成。知道某种技巧不等于已经掌握：高阶操作如落地水不默认让每个角色会用，个人熟练度可在试做和复盘中成长。Kin 合成时也可能漏听呼唤；一次受击可立刻触发保命，却不能自动证明对方有敌意。见[能力设计](docs/ability.md)与[注意力/意图设计](docs/attention-intent.md)。
...
- [游戏能力与成长](docs/ability.md)：能力起点、动作掌握范围、装备条件与自主练习。
- [交互注意力与攻击意图](docs/attention-intent.md)：专注任务、漏听提醒、受击保命与社会判断。
