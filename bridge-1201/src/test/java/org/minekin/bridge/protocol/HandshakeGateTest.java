...
final class HandshakeGateTest {
     ...
     *
     * <p>Root 1.20.1 is allowed to say exactly one pair of versions — the game and the
     ...
     * carrying {@code 1.21.4}/{@code 0.16.9} here would be a Bridge reporting an
    ...
    void onlyTheVersionPairThisRootActuallyRunsIsAccepted() {
        HandshakeGate.Expected pinned = expected("1.20.1", "0.19.5");
        assertEquals("1.20.1", pinned.minecraftVersion());
        assertEquals("0.19.5", pinned.fabricLoaderVersion());

        IllegalArgumentException refused =
                assertThrows(IllegalArgumentException.class, () -> expected("1.21.4", "0.16.9"));
        assertTrue(refused.getMessage().contains("1.20.1 candidate"));
    }
