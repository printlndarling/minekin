 ...
 * that identity names a recipe this 1.21.4 root does not run.
 */
final class BootstrapDescriptorAdapterTest {
    ...
    void adaptRoutesTheRealRuntimeVersionsIntoTheHandshake() {
        ...
        assertEquals("1.21.4", adapted.expected().minecraftVersion());
        assertEquals("0.16.9", adapted.expected().fabricLoaderVersion());
    }
